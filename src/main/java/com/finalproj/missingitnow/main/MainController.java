...
public class MainController {
	...
	public String mainBtn2(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0001 = productService.selectProduct0001();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn3(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0002();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn4(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0003();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn5(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0004();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn6(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0005();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn7(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0006();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn8(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0007();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn9(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0008();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn10(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0009();
		Gson gson = new GsonBuilder().setDateFormat("").create();
	...
	public String mainBtn11(Model model, HttpServletRequest request) {
		...
		List<ProductListDTO> selectProduct0002 = productService.selectProduct0010();
		Gson gson = new GsonBuilder().setDateFormat("").create();
