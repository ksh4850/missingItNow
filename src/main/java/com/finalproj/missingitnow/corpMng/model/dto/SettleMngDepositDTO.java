...
public class SettleMngDepositDTO implements Serializable {
	
	private static final long serialVersionUID = -2123990277526122351L;
	...
	public SettleMngDepositDTO() {
	}

	public SettleMngDepositDTO(String depositNo, String corpNo, CorpUserDTO corpUser, String depositSort, int amount,
	...
	public String toString() {
		return "[depositNo=" + depositNo + ", corpNo=" + corpNo + ", corpUser=" + corpUser
