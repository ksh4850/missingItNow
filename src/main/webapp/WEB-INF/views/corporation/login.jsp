...
<body>
    <section class="member-login-sec">
        <div class="member-login-box">
            ...
            <form id="memberLoginForm" action="${ pageContext.servletContext.contextPath }/member/login" method="POST">
                <div>
                ...
                <div class="btns">
                    ...
                    <a href="${ pageContext.servletContext.contextPath}/controller/regist"><button type="button" class="regist-button">회원가입</button></a><br>
