...
<body>
    ...
    <div class="system-qnaDetail">
        ...
        <form action="${ pageContext.servletContext.contextPath }/admin/qna/update" method="post">
            <label for="">Q&amp;A 제목</label><br>
            <input type="hidden" name="no" value="${ qna.no }">
            <input class="title" name="title" style="min-height: 30px; line-height: 30px;" value="${ qna.title }">
            <br>
...
<script>
	...
	window.onload = function(){
		...
		var $imgs = document.getElementsByClassName("detailImg");
		var $thumb = $(".communty-regist-thumb");
		
		for(var i = 0 ; i < $imgs.length ; i++){
			var $thumDiv  =$("<div class='thum-div'>");
			var $itag2 = $('<i class="xi-close xi-2x">');
			var src = $(".detailImg").eq(i).attr("src");
			var $thumbImg = $('<img class="thumbImg">').attr("src", src).css("width","120px").css("height","120px");
