...
<body>
	...
	<div class="section">
        <h1 style="position: relative; left: 20px;">상품등록</h1>
                ...
                <table class="insertProductTable">
                    ...
                    <tr>
                        ...
                        <td style="text-indent: 20px;">
                            <input type="text" name="prodName" style="width: 900px; height: 30px; font-size: 20px;" placeholder=" 상품명을 입력해주세요." required>
                        </td>
                    </tr>
                    <tr>
                        <td style="text-align: right;">* 제조사 : </td>
                        <td style="text-indent: 20px;">
                            <input type="text" name="prodManufacturer" style="width: 400px; height: 30px; font-size: 20px;" placeholder=" 제조사를 입력해주세요." required>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td style="text-align: right;">* 판매가 : </td>
                        <td style="text-indent: 20px;">
                            <input type="number" min="10" name="prodPrice" style="width: 200px; height: 30px; font-size: 20px; text-align: right;" required> 원
                        </td>
                    </tr>
                    <tr>
